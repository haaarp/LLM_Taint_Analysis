...
inverse_map_pred = {'logging':'log', 'nfc communication':'nfc','nfc information':'nfc', 'audio information':'audio','audio':'audio',
       ...
       'network information':'network','database':'database','database information':'database','notification':'notification', 'log':'log', 'geolocation' : 'geolocation'}
